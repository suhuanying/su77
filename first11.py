...
if page=='项目介绍':
    ...
    with b2:
        images =[
            {
                 'url':"https://github.com/suhuanying/su77/raw/main/1.png",
                 'parm':'各专业性别分布分析'
             },
            {
                 'url':"https://github.com/suhuanying/su77/raw/main/2.png",
                 'parm':'各专业核心学习指标对比'
            },
            {
                 'url':"https://github.com/suhuanying/su77/raw/main/3.png",
                  'parm':'各专业上课出勤率分布'
            },
            {
                 'url':"https://github.com/suhuanying/su77/raw/main/4.png",
                 'parm':'大数据管理专业专项分析'
            }
        ]
